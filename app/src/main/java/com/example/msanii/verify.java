...
public class verify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enteredPhoneNumber = intent.getStringExtra("phonenumber");
...
//                   Show the pop-up dialog showing authentication
            ...
            {
                Toast.makeText(verify.this,"Verification failed " + e.getMessage(),Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(verify.this,"Successful " , Toast.LENGTH_LONG).show();
                        ...
                        else
                        {
                            ...
                            Toast.makeText(verify.this,"Failed", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
